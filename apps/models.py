...
from django.db.models import ForeignKey, CharField, ImageField, TextField, CASCADE, ManyToManyField, \
    SlugField, SET_NULL
...
class Blog(BaseModel):
    ...
    branch = ForeignKey('Branch', CASCADE, null=True, blank=True)
    tag = ManyToManyField('Tag')

    author = ForeignKey('Author', SET_NULL, null=True)
...
class Creators(BaseModel):
    ...
    photo = ImageField(upload_to=f'frontend/scr/assets/creators/')
...
class Author(BaseModel):
    ...
    last_name = CharField(max_length=255)
    about = RichTextField()
    photo = ImageField(upload_to=f'frontend/scr/assets/authors/')
